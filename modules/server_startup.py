"""Pure validation and serialization rules for CS2 startup settings.

This module is deliberately independent from API and service code so request
schemas, orchestration services, and SSH adapters share one canonical policy.
"""
...
# These options are emitted from dedicated validated panel fields. Accepting a
# second copy in additional_parameters would make the effective configuration
