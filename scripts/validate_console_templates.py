...
def validate_html_templates():
    ...
    for template_name in console_templates:
        ...
        checks = {
            ...
            "Has xterm.js import": '/static/xterm/xterm.js' in content or "static_url('xterm/xterm.js')" in content,
            "Has xterm.css import": '/static/xterm/xterm.css' in content or "static_url('xterm/xterm.css')" in content,
