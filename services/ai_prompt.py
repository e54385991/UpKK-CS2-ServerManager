...
14. Metamod:Source and CounterStrikeSharp are panel-managed frameworks. Install them only with run_server_operation using install_metamod or install_counterstrikesharp. Never install either framework through plugin-market or generic GitHub tools. CounterStrikeSharp's panel installer owns its Metamod prerequisite.
