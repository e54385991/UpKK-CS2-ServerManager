...
_TEXT = {
    "en": {
        ...
        "change_map_title": "Change the current map",
        "change_map_label": "Map name or Workshop ID",
        "change_map_placeholder": "ze_saw or 3171881962",
        "change_map_results": "🗺️ Maps matching **{query}**",
        "change_map_hint": "Choose a map. Workshop maps send host_workshop_map to the game.",
        "no_maps": "No map matched that name or Workshop ID.",
    ...
    "zh": {
        ...
        "console_label": "命令",
        "console_placeholder": "status",
        "change_map_title": "更换当前地图",
        "change_map_label": "地图名称或工坊 ID",
        "change_map_placeholder": "ze_saw 或 3171881962",
        "change_map_results": "🗺️ 匹配 **{query}** 的地图",
        "change_map_hint": "选择地图。创意工坊地图会向游戏发送 host_workshop_map。",
        "no_maps": "没有匹配到该名称或工坊 ID。",
