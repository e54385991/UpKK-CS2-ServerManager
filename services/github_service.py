...
def determine_category(repo_info: dict) -> str:
    ...
    dependency_keywords = [
        "metamod", "sourcemod", "counterstrikesharp", "cs2fixes",
        "library", "framework", "api", "core", "base", "sdk"
    ]
    
    functionality_keywords = [
        "admin", "management", "manager", "server", "tool", "utility",
        "monitor", "stats", "ranking", "rank"
    ]
    
    entertainment_keywords = [
        "fun", "game", "mini", "event", "bhop", "surf", "kz", 
        "climb", "jump", "race", "arena", "deathmatch",
        "entertainment", "娱乐"
    ]
